...
def format_hook_research_outcome_board_markdown(
    ...
    lines = [
        ...
        f"| Topic scan counts | {_format_metrics(board.search_summary.topic_scan_counts)} |",
        f"| Qualified sources | {board.search_summary.qualified_sources} |",
        f"| Qualified platform counts | {_format_metrics(board.search_summary.qualified_platform_counts)} |",
        f"| Qualified format counts | {_format_metrics(board.search_summary.qualified_format_counts)} |",
        f"| Qualified topic counts | {_format_metrics(board.search_summary.qualified_topic_counts)} |",
        f"| Metrics incomplete sources | {board.search_summary.metrics_incomplete_sources} |",
        f"| Gate rejected sources | {board.search_summary.gate_rejected_sources} |",
