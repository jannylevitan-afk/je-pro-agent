        ...
        return self._client.generate_text(
            ...
            user_prompt="\n".join(
                [
                    ...
                    "Only the required hook may be reused verbatim. Paraphrase the rest of the source and body into a new script.",
                    "Body points:",
        ...
        raw = self._client.generate_text(
            ...
            user_prompt="\n".join(
                [
                    ...
                    "- Start draft_text_ru with one unique source-specific opening sentence.",
                    "- If draft_text_en is required, start it with one unique source-specific English opening sentence.",
                    "- The opening sentence is not a separate Hook output; it is the first sentence of Final Text.",
                    "- Opening sentence input: topic, audience, platform, angle, emotional_trigger, content_goal, tone, language.",
                    "- Opening sentence rules: 5-14 words, clear without context, no polite intro, one strong semantic hit.",
                    "- It must address a problem, desire, mistake, conflict, benefit, fear, or recognition point for the audience.",
                    "- It must create a reason to read the next line without revealing the whole post.",
                    ...
                    f"Opening sentence guide: {brief.hook}",
                    f"Angle: {brief.angle}",
                    "Key points:",
