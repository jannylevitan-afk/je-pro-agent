        ...
        _bullet_list(
            {
                ...
                "first 3 seconds": intake.first_3_seconds,
                "source hook": intake.source_hook,
                "visual device": intake.visual_device,
                "hook pattern": intake.hook_pattern,
                "hook tension": intake.hook_tension,
                "hook promise": intake.hook_promise,
                "hook CTA": intake.hook_cta,
                "repeatable formula": intake.repeatable_formula,
                "hook modality": intake.hook_modality,
                "public comments / reactions": intake.comments_sample,
